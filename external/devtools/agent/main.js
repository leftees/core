...
(function() {
  ...
  this.spawnProxy = function() {
    ...
    this.proxy = spawn('node', [__dirname + '/server.js',this.port,this.host,this.internal_port], process.argv, {
      env: process.env,
      cwd: __dirname
    });
   ...
   * @api public
   **/
  this.start = function(port,host,internal_port) {
    var self = this;
 ...
 **/
var nodeAgent = module.exports = exports = DevToolsAgent;
